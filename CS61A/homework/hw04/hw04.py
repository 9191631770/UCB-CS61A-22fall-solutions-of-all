...
def balanced(m):
    ...
    if length(end(left_arm)) * total_weight(end(left_arm)) == length(end(right_arm)) * total_weight(end(right_arm)) and balanced(end(left_arm)) and balanced(end(right_arm)):
        return True
    return False
...
def check_par():
    ...
    True
    """
    r1 = par1(interval(1, 2), interval(3, 4))
    r2 = par2(interval(1, 2), interval(3, 4))
    return r1, r2
