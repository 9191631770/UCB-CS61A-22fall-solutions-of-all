...
def count_coins(change):
    ...
    def with_denomination(n, m):
        if n < 0:
            ...
            return with_denomination(n - m, m) + with_denomination(n, next_smaller_coin(m))
    return with_denomination(change, largest)
