...
def is_always_roll(strategy, goal=GOAL):
    ...
    while score0 < 100:
        score1 = 0
        while score1 < 100:
            if(basic != strategy(score0, score1)):
                return False
            score1 += 1
        score0 += 1
    return True
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    def rm_args(n):
        return averaged_dice(n,dice)
    while count <= 10:
        curr_score = rm_args(count)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    threshold = averaged_dice(6)
    return square_strategy(score, opponent_score, threshold)
    # END PROBLEM 12
